...
class BlogPosts(models.Model):
    ...
    category = models.ForeignKey(PostCategory, on_delete=models.CASCADE, blank=True, null=True, default=None)
...
class PostComment(models.Model):
    post = models.ForeignKey(BlogPosts, on_delete=models.CASCADE, related_name='comments', blank=True, null=True)
